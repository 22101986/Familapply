 ...
 */
final class Version20220217133940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person ADD name VARCHAR(255) DEFAULT NULL, ADD nom VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person DROP name, DROP nom');
